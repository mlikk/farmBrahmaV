      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex w-full min-h-screen",
              className
            )}
            ref={ref}
            {...props}
...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden md:flex md:shrink-0 flex-col text-sidebar-foreground"
        data-state={state}
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-2 shrink-0", "group-data-[collapsible=icon]:p-2", className)}
      {...props}
    />
  )
})
